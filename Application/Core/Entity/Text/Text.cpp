...
{
	Logger::LogImportant(std::string("Create text"));
	Logger::LogImportant(std::string("Loading the font from ") + m_Path);
...
TextEntity::~TextEntity(void) {
	Logger::LogImportant(std::string("Deleting the text"));
	TTF_CloseFont(m_Font);
	Logger::LogMessage(std::string("The font closed"));
	SDL_DestroyTexture(m_Texture);
	Logger::LogImportant(std::string("The texture deleted"));
